...
const Intl_1 = require("../lib/core/Intl");
const messages_en = {
    hellow: "hellow,{name}!",
    fxxk: "fxxk you,{name}!",
};
...
// 创建Intl实例对象
const Intl_EN = (0, Intl_1.createIntl)(config_en);
const Intl_ZH = (0, Intl_1.createIntl)(config_zh);
// -------------国际化自定义文本(message国际化)-----------------------
...
// -------------------国际化货币-------------------
const msg7 = Intl_EN.formatNumber(1000, {
    style: 'currency',
    currency: 'USD'
});
const msg8 = Intl_ZH.formatNumber(1000, {
    style: 'currency',
    currency: 'CNY'
});
// -------------------国际化时间-------------------
