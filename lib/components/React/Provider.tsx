// import { createIntlCache } from '../core/Intl'
// import type { IntlCache } from '../core/Intl'


// /**格式化国际化参数*/
// function processIntlConfig(config: any) {
//     return {
...
//     useEffect(() => {
//         if (!cache && !config) {
//             const initCache = createIntlCache()         // 存放Intl的Cache
